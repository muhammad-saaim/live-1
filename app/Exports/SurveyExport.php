...
class SurveyExport implements FromView, WithEvents
{
    ...
    public function __construct($user, $survey_id = null, $start_date = null, $end_date = null)
    {
        $this->user = $user;
        $this->survey_id = $survey_id;

        // If no dates provided, set defaults
        $this->start_date = $start_date ?: UsersSurveysRate::min('created_at');
    ...
    public function view(): View
    {
        $UserSurveys = UsersSurveysRate::select([
            ...
            ->whereBetween('users_surveys_rates.created_at', [$this->start_date, $this->end_date])
            ->get();
