...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateTotal() {
        ...
        serviceCheckboxes.forEach(function(checkbox) {
            if (checkbox.checked) {
                ...
                const hasChildOptions = checkbox.closest('.border-b').querySelectorAll('.child-checkbox').length > 0;
                if (hasChildOptions) {
                    // Count selected children
                    const childCheckboxes = checkbox.closest('.border-b').querySelectorAll('.child-checkbox:checked');
                    const quantity = Math.max(1, childCheckboxes.length);
    ...
    serviceCheckboxes.forEach(function(checkbox) {
        checkbox.addEventListener('change', function() {
            ...
            // Enable/disable the quantity input to ensure only checked services submit quantity
