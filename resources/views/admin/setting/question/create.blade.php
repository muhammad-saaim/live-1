                    ...
                    <form action="{{ route('question.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="question" id="question" rows="3" maxlength="250" required
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300
                                            focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('question') }}
                            </textarea>
                        </div>
                     ...
                     focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="points" id="points" value="{{ old('points', 1) }}" min="1" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div class="mb-4">
                            <label for="reverse_score" class="block text-sm font-medium text-gray-700">Reverse Score</label>
                            <select name="reverse_score" id="reverse_score" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="1" {{ old('reverse_score', 1) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('reverse_score', 1) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>

                        <div class="flex items-center justify-end">
                            <a href="{{ route('question.index') }}" class="text-gray-600 hover:text-gray-900">{{ __('Cancel') }}</a>
